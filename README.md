...
For Claude Desktop, configure a custom Anthropic-compatible gateway/provider with:
...
- `CODEX_CONTEXT_RESERVE_TOKENS`: reserve kept for output, instructions, and token-estimation drift. Default: `32768`.
- `CODEX_MAX_INPUT_TOKENS`: advertised and enforced input context budget for `/v1/models` and `/v1/messages`. Default: `367232`.
